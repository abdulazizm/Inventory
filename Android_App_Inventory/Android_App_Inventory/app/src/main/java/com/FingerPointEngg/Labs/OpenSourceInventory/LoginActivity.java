    ...
    class LoginTask extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                URL url = new URL("https://<your-domain-name>/Android_App/InventoryManagement/onLogin.php");
...
//                        + "=" + URLEncoder.encode(u_input, "UTF-8");
                ...
                URL url = new URL("https://<your-domain-name>/Android_App/InventoryManagement/forgot_password.php");
                HttpsURLConnection urlConnection = (HttpsURLConnection) url.openConnection();
                urlConnection.setRequestProperty("Accept-Encoding", "identity");
                urlConnection.setDoOutput(true);
