    ...
    class RegisterTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            protected String doInBackground (String...strings){
                ...
                try {
                    //return "{\"status\":\"success\",\"user\":\"created\",\"cid\":\"1\"}";
                    //https://www.fingerpointengg.com/Android_App/InventoryManagement/onRegister.php?company_name=KR&p_user=aziz&p_pass=1234
                ...
                URL url = new URL("https://www.fingerpointengg.com/Android_App/InventoryManagement/onRegister.php");
